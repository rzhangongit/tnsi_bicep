...
param storageAccountContainerSAStoken string

var serverName = 'anasrv${projectAlias}'
// This SAS token of the key needs to have Read, List, and Write permissions to the storage container.
var backupBlobContainerUri = storageAccountContainerSAStoken
